      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className='md:justify-self-center'>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/installation" className="text-neutral-grey transition-colors hover:text-primary">
                Documentation
              </Link>
            </li>
            <li>
              <Link to="/button" className="text-neutral-grey transition-colors hover:text-primary">
                Components
              </Link>
            </li>
            <li>
