// V1 Button - Latest version (copy from main button)
...
export const buttonVariants = cva(
  `bg-yellow-500! btn-ripple  active:scale-[0.97] ring-offset-background focus-visible:ring-ring relative inline-flex select-none flex-wrap items-center justify-center overflow-hidden whitespace-nowrap text-sm font-medium
