...
const PluginsOverview = () => {
  ...
  return (
    <Container className="my-10">
      {/* Header */}
      <div className="mb-10">
        <h1 className="mb-3 text-4xl font-bold">Plugins</h1>
        <p className="text-lg text-neutral-grey">
          TRA UI Base pluginleri; Axios, i18n, SignalR ve daha fazlası için hazır altyapı
          kurulumları sağlar. Her plugin bağımsız olarak projenize eklenebilir.
        </p>
      </div>
      ...
      <div className="mb-10 flex items-start gap-3 rounded-xl border border-primary/20 bg-primary/5 px-5 py-4">
        ...
        <div>
          <p className="font-semibold text-foreground">tra-ui-cli ile hızlı kurulum</p>
        ...
        {Constants.pluginList.map((plugin) => (
          ...
          >
            ...
            <div className="mt-4 flex items-center gap-1 text-sm font-medium text-primary opacity-0 transition-opacity group-hover:opacity-100">
              Dokümantasyona git <ArrowRightIcon size={14} />
            </div>
          </Link>
        ))}
      </div>
