    ...
    <div className="min-h-screen">
      ...
      <section className="relative flex min-h-[90vh] flex-col items-center justify-center overflow-hidden px-4">
        ...
        <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
          <motion.div
            animate={
              prefersReducedMotion ? {} : { scale: [1, 1.2, 1], opacity: [0.25, 0.45, 0.25] }
            }
          ...
          <motion.div
            animate={
              prefersReducedMotion ? {} : { scale: [1, 1.3, 1], opacity: [0.25, 0.45, 0.25] }
            }
          ...
          <div className="hidden md:block">
            ...
            <motion.div
              animate={
                prefersReducedMotion
                  ? {}
                  : { y: [0, 25, 0], rotate: [0, 5, 0], opacity: [0.2, 0.3, 0.2] }
              }
            ...
            <motion.div
              animate={
                prefersReducedMotion ? {} : { x: [-10, 10, -10], opacity: [0.15, 0.28, 0.15] }
              }
            ...
            <motion.div
              animate={
                prefersReducedMotion
                  ? {}
                  : { y: [0, -15, 0], x: [0, 10, 0], opacity: [0.2, 0.32, 0.2] }
              }
            ...
            <motion.div
              animate={
                prefersReducedMotion
                  ? {}
                  : { y: [0, -20, 0], scale: [1, 1.08, 1], opacity: [0.18, 0.28, 0.18] }
              }
            ...
            <motion.div
              animate={
                prefersReducedMotion
                  ? {}
                  : { y: [0, 20, 0], rotate: [0, -5, 0], opacity: [0.2, 0.32, 0.2] }
              }
            ...
            <motion.div
              animate={
                prefersReducedMotion ? {} : { scale: [1, 1.12, 1], opacity: [0.15, 0.28, 0.15] }
              }
