...
const accordionApiTableData = [
  {
    prop: 'variant',
    type: '"underlined" | "outlined" | "solid" | "splitted"',
    default: '"underlined"',
...
const accordionItemApiTableData = [
  { prop: 'title', type: 'string', default: '-', description: 'The title of the accordion item' },
  {
    ...
    type: 'string',
    default: '-',
    description: 'Optional subtitle for the accordion item',
  },
  // { prop: 'defaultOpen', type: 'boolean', default: 'false', description: 'Whether the item is open by default' },
  {
    ...
    type: 'string',
    default: '-',
    description: 'Custom class name for the accordion item',
  },
  {
    prop: 'triggerClassName',
    type: 'string',
    default: '-',
    description: 'Custom class name for the accordion item trigger',
  },
  {
    prop: 'contentClassName',
    type: 'string',
    default: '-',
    description: 'Custom class name for the accordion item content',
  },
  {
    prop: 'titleClassName',
    type: 'string',
    default: '-',
    description: 'Custom class name for the accordion item title',
  },
  {
    prop: 'disabled',
    type: 'boolean',
  ...
  },
  {
    ...
    type: 'ReactNode',
    default: '-',
    description: 'Custom icon for the accordion item',
  },
  {
    prop: 'startContent',
    type: 'ReactNode',
    default: '-',
    description: 'Content displayed at the start of the item',
  },
];
    ...
    <p>This is the content of Section 1</p>
      ...
      <section id="variants">
        ...
        >
          ...
          <CustomSyntaxHighlighter
            content={`<Accordion multipleExpand>
  ...
  <AccordionItem title="Section 3" icon={<PlusIcon />}>
    <p>This is the content of Section 3</p>
        ...
        >
          ...
          <CustomSyntaxHighlighter
            content={`<Accordion variant="outlined">
  ...
  <AccordionItem title="Section 3">
    <p>This is the content of Section 3</p>
        ...
        >
          ...
          <CustomSyntaxHighlighter
            content={`<Accordion variant="solid">
  <AccordionItem title="Section 1" subTitle="Sub Title">
    <p>This is the content of Section 1</p>
    <p>This is the content of Section 1</p>
  </AccordionItem>
  ...
  <AccordionItem title="Section 3">
    <p>This is the content of Section 3</p>
        ...
        >
          ...
          <CustomSyntaxHighlighter
            content={`<Accordion variant="splitted">
  <AccordionItem title="Section 1" subTitle="Sub Title">
    <p>This is the content of Section 1</p>
    <p>This is the content of Section 1</p>
  </AccordionItem>
  ...
  <AccordionItem title="Section 3">
    <p>This is the content of Section 3</p>
      ...
      <section id="api">
        ...
        <ApiTable
          title="Accordion"
          tableData={accordionApiTableData}
          titleClassName="text-xl font-semibold"
        />
        <ApiTable
          title="Accordion Item"
          tableData={accordionItemApiTableData}
          titleClassName="text-xl font-semibold"
        />
      </section>
    </div>
