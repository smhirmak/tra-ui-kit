...
const LanguageSelectPage = () => {
  ...
  return (
    <div className="space-y-12">
      {/* Overview */}
      <section id="overview">
        <h1 className="mb-4 text-4xl font-bold">Language Select</h1>
        <p className="text-lg text-neutral-grey">
          A language selector dropdown with flag icons for internationalization (i18n) support.
        </p>
      </section>
      ...
      <section id="installation">
        ...
        <p className="mt-4 text-sm text-neutral-grey">
          This component uses the Select component and LocalizeContext for language management.
        </p>
      </section>
