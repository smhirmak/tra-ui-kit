    ...
    <div className="space-y-12">
      ...
      <section id="overview">
        ...
        <p className="text-lg text-neutral-grey">
          A versatile checkbox component with multiple variants, sizes, and states for user
          selections.
        </p>
      </section>
      ...
      <section id="sizes">
        ...
        <CustomSyntaxHighlighter
          className="mb-2"
          content='<Checkbox id="sm" size="sm" label="Small" />'
        />
        <CustomSyntaxHighlighter
          className="mb-2"
          content='<Checkbox id="default" label="Default" />'
        />
      ...
      <section id="states">
        ...
        <p className="mb-4 text-neutral-grey">
          Checkboxes support various states including checked and disabled.
        </p>
        <div className="rounded-lg border border-border bg-background p-6">
          <div className="flex flex-wrap gap-4">
            <Checkbox
