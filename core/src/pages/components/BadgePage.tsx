...
const apiTableData = [
  {
    prop: 'color',
    type: '"primary" | "error" | "secondary" | "success" | "tertiary" | "warning"',
    default: '"primary"',
  ...
  { prop: 'text', type: 'string', default: '-', description: 'Text to display in the badge' },
  {
    ...
    type: 'string',
    default: '-',
    description: 'Class name for the text element',
  },
    ...
    <div className="space-y-12">
      ...
      <section id="overview">
        ...
        <p className="text-lg text-neutral-grey">
          A small status indicator component with various colors and sizes for displaying
      ...
      <section id="sizes">
        ...
        <CustomSyntaxHighlighter
          className="mb-2"
          content='<Badge color="primary" size="sm" />'
        />
        <CustomSyntaxHighlighter
          className="mb-2"
      ...
      <section id="with-icon">
        ...
        <p className="mb-4 text-neutral-grey">
          Badges can display icons or combine icon with text.
        </p>
        <div className="rounded-lg border border-border bg-background p-6">
          <div className="flex flex-wrap gap-4">
            <Badge
