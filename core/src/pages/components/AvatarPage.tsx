...
const apiTableData = [
  ...
  },
  {
    ...
    type: 'string',
    default: '-',
    description: 'Render as a different element (e.g., "a")',
  },
];
    ...
    <div className="space-y-12">
      ...
      <section id="overview">
        ...
        <p className="text-lg text-neutral-grey">
          Avatar component for displaying user profile images with various sizes, shapes, and badge
          support.
        </p>
      </section>
      ...
      <section id="sizes">
        ...
        <CustomSyntaxHighlighter
          className="mb-2"
          content='<Avatar size="sm" src="/assets/logos/logo.png" />'
        />
        <CustomSyntaxHighlighter content='<Avatar src="/assets/logos/logo.png" />' />
      </section>
        ...
        <div className="rounded-lg border border-border bg-background p-6">
          <div className="flex flex-wrap gap-4">
            ...
            <Avatar
              src="/assets/logos/logo.png"
              badgePosition="bottom-right"
              badgeContent={<Badge color="secondary" />}
            />
          </div>
        </div>
      ...
      <section id="multiple">
        ...
        <p className="mb-4 text-neutral-grey">
          Display multiple avatars in a container with overflow indicator.
        </p>
        <div className="rounded-lg border border-border bg-background p-6">
          <MultipleAvatarContainer
            lastElementSize="sm"
            childrenClassName="border-background border-4"
          >
            <Avatar
              size="sm"
              asChild="a"
              href="/asd"
              target="_blank"
              className="bg-neutral-grey text-black"
            />
            <Avatar
              size="sm"
              src="/assets/logos/logo.png"
            ...
            <Avatar
              size="sm"
              className="bg-disabled-light-dark"
            />
            <Avatar
              size="sm"
              src="/assets/logos/logo.png"
        ...
        <CustomSyntaxHighlighter
          content={`<MultipleAvatarContainer lastElementSize="sm" childrenClassName="border-background border-4">
