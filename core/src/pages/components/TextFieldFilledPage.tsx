    ...
    <div className="mb-6 border-b-2 pb-6">
      ...
      <div className="mt-2 border-t-2 py-2">
        ...
        <div className="mb-2 flex space-x-4">
          <TextField value={value} onChange={e => setValue(e.target.value)} id="1" name="1" showRequiredIcon label="Label" size="sm" />
          <TextField value={value} onChange={e => setValue(e.target.value)} id="2" name="2" label="Label" size="sm" />
          <TextField value={value} onChange={e => setValue(e.target.value)} id="3" name="3" label="Error" size="sm" error />
          <TextField value={value} onChange={e => setValue(e.target.value)} id="4" name="4" label="Error" size="sm" error borderRadius="lg" />
          <TextField value={value} onChange={e => setValue(e.target.value)} id="5" name="5" label="Disabled" size="sm" disabled />
        </div>
        <div className="mb-2 flex space-x-4">
...
export default TextFieldFilledPage;
