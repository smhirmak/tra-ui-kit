...
const apiTableData = [
  ...
  },
  {
    ...
    type: 'boolean',
    default: 'false',
    description: 'Disable closing with Escape key',
  },
    ...
    <div className="space-y-12">
      ...
      <section id="overview">
        ...
        <p className="text-lg text-neutral-grey">
          A slide-out panel component for displaying additional content or navigation from any edge
          of the screen.
        </p>
      </section>
            ...
            <div className="rounded-lg border border-border bg-background p-6">
              <Drawer>
                <DrawerTrigger asChild>
                  <Button size="sm">Custom Button</Button>
                </DrawerTrigger>
                <DrawerContent>
                  <DrawerHeader>
    ...
    <DrawerBody>
      ...
      <section id="positions">
        ...
        <div className="space-y-4">
          ...
          <CustomSyntaxHighlighter
            content={`<Drawer position="left">...</Drawer>
