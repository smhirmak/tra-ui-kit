...
const apiTableData = [
  ...
  { prop: 'variant', type: '"filled" | "outlined" | "underlined"', default: '"filled"', description: 'Visual variant style' },
  { prop: 'size', type: '"sm" | "default" | "lg"', default: '"default"', description: 'Input field size' },
...
/>`}
      ...
      <section id="variants">
        ...
        <div id="filled" className="mb-8 space-y-4">
          ...
          <div className="rounded-lg border border-border bg-background p-6">
            <div className="flex flex-wrap gap-4">
              <SearchField value={value} onChange={(e) => setValue(e.target.value)} />
              <SearchField value={value} onChange={(e) => setValue(e.target.value)} label="Search" />
              <SearchField value={value} onChange={(e) => setValue(e.target.value)} placeholder="Search items..." />
            </div>
          </div>
        ...
        <div id="outlined" className="mb-8 space-y-4">
          ...
          <div className="rounded-lg border border-border bg-background p-6">
            <div className="flex flex-wrap gap-4">
              <SearchField variant="outlined" value={value} onChange={(e) => setValue(e.target.value)} />
              <SearchField variant="outlined" value={value} onChange={(e) => setValue(e.target.value)} label="Search" />
              <SearchField variant="outlined" value={value} onChange={(e) => setValue(e.target.value)} placeholder="Search items..." />
            </div>
          </div>
        ...
        <div id="underlined" className="mb-8 space-y-4">
          ...
          <div className="rounded-lg border border-border bg-background p-6">
            <div className="flex flex-wrap gap-4">
              <SearchField variant="underlined" value={value} onChange={(e) => setValue(e.target.value)} />
              <SearchField variant="underlined" value={value} onChange={(e) => setValue(e.target.value)} label="Search" />
              <SearchField variant="underlined" value={value} onChange={(e) => setValue(e.target.value)} placeholder="Search items..." />
            </div>
          </div>
      ...
      <section id="sizes">
        ...
        <div className="rounded-lg border border-border bg-background p-6">
          <div className="flex flex-wrap items-center gap-4">
            <SearchField size="sm" value={value} onChange={(e) => setValue(e.target.value)} placeholder="Small" />
            <SearchField size="default" value={value} onChange={(e) => setValue(e.target.value)} placeholder="Default" />
            <SearchField size="lg" value={value} onChange={(e) => setValue(e.target.value)} placeholder="Large" />
          </div>
        </div>
        <CustomSyntaxHighlighter className="mb-2" content='<SearchField size="sm" ... />' />
        <CustomSyntaxHighlighter className="mb-2" content='<SearchField size="default" ... />' />
      ...
      <section id="disabled-state">
        ...
        <div className="rounded-lg border border-border bg-background p-6">
          <div className="flex flex-wrap gap-4">
            <SearchField value={value} onChange={(e) => setValue(e.target.value)} disabled />
            <SearchField variant="outlined" value={value} onChange={(e) => setValue(e.target.value)} disabled />
          </div>
        </div>
