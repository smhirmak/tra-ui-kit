...
const Calendar = ({
  ...
  <DayPicker
    ...
    classNames={{
      ...
      cell: 'h-9 w-9 text-center text-sm p-0 relative [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-tra-primary/50 [&:has([aria-selected])]:rounded-md [&:has([aria-selected])]:bg-tra-primary first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20',
      day: cn(
      ...
      day_range_middle:
          'aria-selected:bg-tra-primary aria-selected:text-accent-foreground',
